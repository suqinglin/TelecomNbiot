...
/**
 * Query Upgrade Tasks :
 * This interface is used to query upgrade task list.
 */
public class QueryUpgradeTasks {
	...
	public static void main(String args[]) throws Exception {
        ...
        StreamClosedHttpResponse responseQueryUpgradeTasks = httpsUtil.doGetWithParasGetStatusLine(urlQueryUpgradeTasks, null, header);
